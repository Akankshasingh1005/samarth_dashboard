    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
        ...
        <div className="stat-card">
          ...
          <span className="text-xs text-indigo-600 font-semibold mt-1">PS2 AI Form Quality</span>
        </div>
      </div>
        ...
        <div className="samarth-card p-6 flex flex-col justify-between">
          ...
          <div className="h-52 flex items-center justify-center relative">
            ...
            <div className="relative w-40 h-40 rounded-full border-8 border-slate-100 flex items-center justify-center">
              <div className="absolute inset-0 rounded-full border-8 border-brand border-t-transparent border-r-transparent rotate-45" />
              <div className="text-center">
                <span className="text-4xl font-display font-extrabold text-slate-800 dark:text-slate-100">
                  {summary?.avg_symmetry?.toFixed(0) || '0'}%
                </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="samarth-card p-6">
          <h2 className="text-lg font-display font-bold text-slate-800 dark:text-slate-200 mb-6 flex items-center gap-2">
            <TrendingUp className="w-5 h-5 text-accent" /> Form Quality Over Time (PS2)
          </h2>
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
