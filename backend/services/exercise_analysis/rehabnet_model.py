...
Architecture:
  ST-GCN (3 blocks) → Transformer (2 encoder layers) + BiLSTM (2 layers)
  → Shared MLP → 3 heads: classify (correct/incorrect), quality (score), exercise (type)
...
class RehabNet(nn.Module):
    ...
    def __init__(self):
        ...
        # BiLSTM (2 layers, hidden=64, bidirectional → output=128)
