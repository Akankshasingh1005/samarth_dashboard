...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.info(f"✅ Auto-seeded Day-1 exercises: {res['message']}")
    except Exception as e:
        logger.warning(f"⚠️ Failed to auto-seed exercises: {e}")
...
app = FastAPI(
    ...
    description=(
        ...
        "Wraps PS1 (Computer Vision) with PS2/PS3 integration stubs."
    ),
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
...
async def health_check():
    return {
        ...
        "version": "1.0.0",
        "ps2_mode": "real" if settings.PS2_USE_REAL_MODEL else "mock",
